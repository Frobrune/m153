...
CREATE VIEW ALL_RESERVATIONS AS
    SELECT C.NAME, F.START_TIME, F.ARRIVAL_TIME, R.PRICE FROM RESERVATION R
    INNER JOIN CUSTOMER C on C.ID = R.FK_CUSTOMER
    INNER JOIN FLIGHT F on F.ID = R.FK_FLIGHT
